...
| `metapath_hybrid_reranker` | Vector + query-aware BFS → CrossEncoder | 200 | 20 | ~300 |
| `metapath_hybrid_freq` | Vector + query-aware BFS → frequency | 200 | 20 | ~300 |
| `metapath_hybrid_interleave` | Vector + query-aware BFS → interleave | 200 | 20 | ~300 |
